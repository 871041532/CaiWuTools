...
class ShowWindow(QWidget):
    ...
    def deal_pingzheng_data(self):
        ...
        output_filenames = (
            # key，税率，非主力店科目，主力店科目
            ("仓库租赁费", 1.09, "6001.05", "6001.05", "结转" + kemu_date_str + "仓库租赁费收入 %s-%s-%s", "结转主合同仓库租赁费.xlsx", "2203.01.01", 0),
            ("浮动提成租金", 1.09, "6001.02.02", "6001.02.01", "结转" + kemu_date_str_last_month + "浮动提成租金 %s-%s-%s", "结转主合同浮动提成租金.xlsx", "2203.01.01", 0),
            ("浮动提成租金", 1.09, "2203.01.01", "2203.01.01", "确认" + kemu_date_str_last_month + "浮动提成租金 %s-%s-%s", "确认主合同浮动提成租金.xlsx", "1122.01.01", 1),
            ("固定租金", 1.09, "6001.01.02", "6001.01.01", "结转" + kemu_date_str + "固定租金 %s-%s-%s", "结转主合同固定租金.xlsx", "2203.01.01", 0),
            ("广告位租赁费", 1.09, "6001.08", "6001.08", "结转" + kemu_date_str + "广告位租赁费收入 %s-%s-%s", "结转主合同广告位租赁费.xlsx", "2203.01.01", 0),
