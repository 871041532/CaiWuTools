...
class ShowWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.button1 = QPushButton("选择【凭证查询-收字-高级】导出表")
        ...
        self.out_put_filename2 = Globals.desktop_path + "收到数据采集设备汇总表.xlsx"
        self.out_put_filename = Globals.desktop_path + "结转数据采集设备.xlsx"
        self.refer_filename = ""
        self.refer_data = None
        self.my_data = None

        self.setLayout(mainLayout)
        self.setWindowTitle("结转数据采集设备")
